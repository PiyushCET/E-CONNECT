...
$query="SELECT * FROM `odibro` WHERE BRAND='AIRTEL' ORDER BY VIEWS DESC";
$resul=mysql_query($query);
...
?>
var bac='rgb(49,127,212)';
	 var coa='rgb(219,233,246)';
	 var cob='rgb(241,251,253)';
	 var coc='rgb(94,150,211)';
...
ctx.fillText (y.toFixed(0)+" GB FUP LIMIT", 120+x,1940);
ctx.fillText ('<?php echo $rows['SPEED']; ?>'+"mbps", 230+x,1990);
ctx.fillText ('<?php echo $rows['MONTH']; ?>'+" MONTH(S)", 200+x,2040);
