...
$query="SELECT * FROM `odibro` WHERE BRAND='BSNL' ORDER BY VIEWS DESC";
$resul=mysql_query($query);
...
?>
var bac='rgb(116,6,255)';
	 var coa='rgb(228,209,254)';
	 var cob='rgb(246,237,255)';
	 var coc='rgb(139,72,214)';
